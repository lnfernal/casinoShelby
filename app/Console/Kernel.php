...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        //UpdateRates
        $ratesFrequencyMethod = config('settings.rates.frequency');
        if ($ratesFrequencyMethod) {
            $schedule->command(updateRates::class)->$ratesFrequencyMethod();
        }
        ...
        // update assets
        $schedule->command(SeedCommand::class, ['--class' => AssetSeeder::class, '--force'])->everyFifteenMinutes();
