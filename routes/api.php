...
use App\Http\Controllers\SportListController;
...
Route::get('ActivateSession2', [smartSoftGaming::class, 'index']);

Route::get('test', [SportListController::class, 'index']);

Route::prefix('sendemail')
    ->group(function () {
...
Route::prefix('sports')
    ->group(function () {
        Route::get('display', [SportListController::class, 'show']);
        Route::post('validate', [SportListController::class, 'validate']);
    });
...
Route::middleware(['cookies', 'auth:sanctum', 'maintenance', 'verified', 'active', '2fa', 'last_seen'])
    ->group(function () {
        ...
        Route::get('historySports', [SportListController::class, 'index']);
        Route::get('historySports/user', [SportListController::class, 'user']);
        // history
