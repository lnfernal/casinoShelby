...
return [
     ...
     */
    'rates' => [
        'frequency' => env('UPDATE_RATES_FREQUENCY', 'everyMinute'),
    ],
    ...
    'content' => [
        'home' => [
            ...
            'header' => [
                'logo1' => '/images/icon1.svg',
                'logo2' => '/images/icon2.svg',
                'logo3' => '/images/icon3.svg',
                'logo4' => '/images/icon4.svg',
            ]
        ],
        'leaderboard' => [
        ...
        'regiser' => [
            'welcome'=> [
                'url1' => '/images/main2.jpg',
                'url2' => '/images/bg2.png',
            ]
        ],
        'slider' => [
            'logoRegister' => '/images/icon5.svg',
            'logoVideo' => '/images/icon6.svg',
            'logoBg' => '/images/shape_bg.png'
        ]
    ],
];
