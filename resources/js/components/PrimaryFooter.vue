<template>
  <footer id="primary-footer" class="container">
    <div class="chain_box mx-auto">
      <div class="logo_box mt_20">
        <img src="/images/f1.svg" alt="">
        <img src="/images/f2.svg" alt="">
        <img src="/images/f3.svg" alt="">
      </div>
      <div class="chain_img mt_20">
        <img src="/images/f4.svg" alt="">
      </div>
      <div class="social_box mt_20">
        <a href="https://twitter.com/Shelbytokenio"><img src="/images/t2.svg" alt=""></a>
        <a href="https://www.facebook.com/shelbytoken"><img src="/images/r2.svg" alt=""></a>
        <a href="https://t.me/shelbytokenfrance"><img src="/images/tele2.svg" alt=""></a>
      </div>
    </div>
    <ul>
      <li><a href="/pages/terms-of-use">TERMES ET CONDITIONS</a></li>
      <li><a href="/pages/privacy-policy">POLITIQUE DE CONFIDENTIALITÉ</a></li>
      <li><a href="/pages/provably-fair">JEU RESPONSABLE</a></li>
      <!--<li><a href="#">À PROPOS DE NOUS</a></li>-->
      <li><a href="/contact">CONTACTEZ-NOUS</a></li>
      <li><a href="/contact">FAQ</a></li>
      <!--<li><a href="#">AFFILIÉS</a></li>-->
    </ul>
    <div class="copy_right mx-auto">
      <h5>LE JEU PEUT ÊTRE ADDICTIF. JOUEZ DE MANIÈRE RESPONSABLE. 2021 © SHELBY.CASINO TOUS DROITS RÉSERVÉS.</h5>
      <p>
        <a href="mailto:support@shelby.casino">support@shelby.casino</a> -
        <a href="mailto:partners@shelby.casino">partners@shelby.casino</a>
      </p>
    </div>
  </footer>
  <!--<v-footer
