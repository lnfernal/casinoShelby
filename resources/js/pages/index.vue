<template>
  <div>
    <dynamic-template
      :template="html"
      :components="{ SportsList, Slider, GamesList, IncommingGame, ProviderGamesList, ProvidersList, Predictions, ProvablyFair, BonusCards, Features, Raffles, BiggestWin, RecentGames, Social }"
    />
  </div>
</template>
<script>
...
import IncommingGame from '~/components/Home/IncommingGame'
